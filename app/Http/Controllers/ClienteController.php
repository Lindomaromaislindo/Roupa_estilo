...
class ClienteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('imagem')) {
            ...
            $data['imagem'] = 'cliente/default.png';
        }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->hasFile('imagem')) {
            if ($cliente->imagem && Storage::disk('public')->exists($cliente->imagem) && $cliente->imagem !== 'cliente/default.png') {
    ...
    public function report()
    {
        ...
        $pdf = Pdf::loadView('cliente.report', $data);
        return $pdf->download('relatorio_cliente.pdf');
    }
}
